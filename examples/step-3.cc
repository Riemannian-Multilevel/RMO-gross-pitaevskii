...
// Point value and mean into the .h5 file
...
private:
  ...
  Vector<double> system_rhs;
    ...
    // private variable for the number of global refinement steps
  unsigned int n_refinement_steps = 5;
};
...
void Step3::output_results() const
{
  ...
  // std::cout << "Output written to " << filename << std::endl;
    ...
    // After outputting the solution, the file can be opened again to include more datasets.
    // This allows us to keep all the necessary information of our experiment in a single result file,
    // which can then be read and processed by some postprocessing script.
