 ...
 *
 * Three variants of the mu gate were compared (CONTINUOUS_CUTS.md \S1): the paper's
 ...
 * on the paper's 960x1280 cow image (CONTINUOUS_CUTS.md \S4.2), the scaled restricted
