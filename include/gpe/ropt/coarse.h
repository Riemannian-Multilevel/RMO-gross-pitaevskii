 ...
 * @param y_coarse The target coarse base point $x_H \in \mathcal{S}_H$.
 * @param x_fine The source fine base point $y_h \in \mathcal{S}_h$.
                       ...
                       Vector<double>& dst)
{
    ...
    transport.vector_restriction(y_coarse, x_fine, y_grad_fine, y_grad_restr);
